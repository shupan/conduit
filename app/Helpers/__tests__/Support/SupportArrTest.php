...
class SupportArrTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testAdd()
    {
        ...
        $array = Arr::add(['name' => 'Desk', 'price2'=>100],'price1',10);
        $this->assertEquals(['name' => 'Desk', 'price1' => 10,'price2'=>100], $array);
    }
    ...
    public function testDot()
    {
        ...
        $array = Arr::dot(['foo' => ['bar' => 'baz','bar2' => 'baz2']]);
        $this->assertEquals(['foo.bar' => 'baz','foo.bar2' => 'baz2'], $array);
    ...
    public function testGet()
    {
        ...
        $array = ['products2' => ['price' => 100]];
        $this->assertEquals(['price' => 100], Arr::get($array, 'products2'));

        $array = ['products' => ['desk' => ['price' => 100]]];
        $value = Arr::get($array, 'products.desk');
        $this->assertEquals(['price' => 100], $value);

        $array = ['products' => ['desk' => ['price' => 100], 'card' => ['price' => 100] ]];
        $value = Arr::get($array, 'products.desk');
        $this->assertEquals(['price' => 100], $value);
        $this->assertEquals(['price' => 100], Arr::get($array,'products.card'));
...
//        $array = ['name' => ['Desk','Desk2'], 'price' => 100];
//        $name = Arr::pull($array, 'name');
//        $this->assertEquals(['Desk','Desk2'], $name);
